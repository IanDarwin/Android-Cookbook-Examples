...
This repo is among the largest collections anywhere of Android code samples; it contains
almost a hundred and fifty compilable source code examples from 
