...
N.B. A lot of this stuff is out of date now!

This repo is among the largest collections of Android code samples anywhere; it contains
around a hundred and fifty source code examples from 
http://androidcookbook.com/[the O'Reilly Android Cookbook], which was at the time of its publication a great source 
