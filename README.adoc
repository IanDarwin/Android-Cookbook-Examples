...
| link:https://github.com/IanDarwin/Android-Cookbook-Examples/tree/master/SimpleJumper[SimpleJumper] | E | Common code for flixel-gdx-based gaming demo. | Android ver fails at startup, on loadLibrary("gdx"); call down in framework.
