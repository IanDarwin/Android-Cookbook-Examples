...
We welcome contributions of code, and encourage you to accompany them
with a new recipe on the https://androidcookbook.com[Android Cookbook site].

The editor's decision is final on accepting or rejecting 
pull requests, though :-)

We follow the CCCC, the
