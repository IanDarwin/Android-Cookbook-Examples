 ...
 * {@link MyDataItemListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link MyDataItemDetailFragment}.
 */
public class MyDataItemDetailActivity extends FragmentActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_mydataitem_detail);
		...
		if (savedInstanceState == null) {
			...
			getSupportFragmentManager().beginTransaction()
					.add(R.id.mydataitem_detail_container, fragment).commit();
		}
	}
